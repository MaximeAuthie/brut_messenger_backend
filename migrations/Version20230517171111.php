 ...
 */
final class Version20230517171111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conversation (id INT AUTO_INCREMENT NOT NULL, id_conversation INT NOT NULL, name_conversation VARCHAR(50) NOT NULL, color_conversation VARCHAR(50) NOT NULL, url_avatar_conversation VARCHAR(100) NOT NULL, type_conversation VARCHAR(50) NOT NULL, status_conversation TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE customization (id INT AUTO_INCREMENT NOT NULL, user_customization_id INT NOT NULL, conversation_customization_id INT NOT NULL, id_customization INT NOT NULL, message_color_customization VARCHAR(50) NOT NULL, user_nickname_customization VARCHAR(50) NOT NULL, user_status_customization TINYINT(1) NOT NULL, INDEX IDX_AB0369C6A340ECE0 (user_customization_id), INDEX IDX_AB0369C669550C9C (conversation_customization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, conversation_message_id INT NOT NULL, user_message_id INT NOT NULL, id_message INT NOT NULL, content_message LONGTEXT NOT NULL, hour_date_message DATETIME NOT NULL, status_message TINYINT(1) NOT NULL, INDEX IDX_B6BD307F42664F2B (conversation_message_id), INDEX IDX_B6BD307FF41DD5C5 (user_message_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE public_keys (id INT AUTO_INCREMENT NOT NULL, conversation_public_keys_id INT NOT NULL, user_public_keys_id INT NOT NULL, id_publickeys INT NOT NULL, key_publickeys LONGTEXT NOT NULL, INDEX IDX_CFD3063D401AF524 (conversation_public_keys_id), UNIQUE INDEX UNIQ_CFD3063D68F7488D (user_public_keys_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, id_user INT NOT NULL, first_name_user VARCHAR(50) NOT NULL, last_name_user VARCHAR(50) NOT NULL, nickname_user VARCHAR(50) NOT NULL, email_user VARCHAR(100) NOT NULL, birthday_user DATE NOT NULL, password_user VARCHAR(100) NOT NULL, url_avatar_user VARCHAR(100) NOT NULL, status_user TINYINT(1) NOT NULL, font_size_user VARCHAR(50) NOT NULL, private_key_user LONGTEXT NOT NULL, public_key_user LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
